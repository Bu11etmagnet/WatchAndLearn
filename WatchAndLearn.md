...
|Event|Presenter| Title | Link | Comment |
|-----|-------|-------|------|---------|
| CppCon 2019 | Marshall Clow | [std::midpoint](https://en.cppreference.com/w/cpp/numeric/midpoint) - How hard could it be? | <https://www.youtube.com/watch?v=sBtAGxBh-XI> | As it turns out, quite hard.
